...
cd ../frontend
snyk test --json > ../.circleci/snyk/snyk-frontend.json
sudo cat ../.circleci/snyk/snyk-frontend.json  \
...
snyk test --json > ../.circleci/snyk/snyk-server.json
sudo cat ../.circleci/snyk/snyk-server.json  \
