...
docker-compose build --build-arg PLATFORM='ci-unauthenticated' --build-arg VCAP_SERVICES="$VCAP_SERVICES" --build-arg VCAP_APPLICATION="$VCAP_APPLICATION" fs-intake-server
