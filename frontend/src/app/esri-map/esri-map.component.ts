...
export class EsriMapComponent implements OnInit, OnDestroy {
  ...
  async initializeMap() {
    try {
      ...
      const [Map, MapView, GeoJSONLayer, Search] = await loadModules(['esri/Map', 'esri/views/MapView', 'esri/layers/GeoJSONLayer', 'esri/widgets/Search']);
      ...
      // this.checkForest = function (feature) {
  ...
  //   let timeout;
  //   this.warnUser = function(warning){
  ...
  //   this.view.on('mouse-wheel', function(e) {
  //     this.warnUser('To zoom in please double click the map. Use zoom in/out buttons.');
  //   });
  ...
  //   this.view.on(['pointer-up', 'pointer-leave'], function(e) {
  ...
  //     this.warnUser('Please use two fingers to pan the map.');
  //   });
  //   // Display a warning.
