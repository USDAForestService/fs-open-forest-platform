...
import { FirewoodForestFinderComponent } from './forest-finder.component';
...
describe('FirewoodForestFinderComponent', () => {
  let component: FirewoodForestFinderComponent;
  let fixture: ComponentFixture<FirewoodForestFinderComponent>;
  let router: Router;
