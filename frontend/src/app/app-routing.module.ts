...
const appRoutes: Routes = [
  { path: 'admin/applications', component: PermitApplicationListComponent, data: { title: 'Application administration listing' } },
  { path: 'admin/applications/:id', component: PermitApplicationViewComponent, data: { title: 'View application' } },
  { path: 'applications/noncommercial-group-use/new', component: ApplicationNoncommercialGroupComponent, data: { title: 'Apply for a noncommercial group use permit' } },
  { path: 'applications/submitted/:id', component: ApplicationSubmittedComponent, data: { title: 'Application submitted for review' } },
  { path: 'applications/temp-outfitters/new', component: TemporaryOutfittersComponent, data: { title: 'Apply for a temporary outfitters permit' } },
