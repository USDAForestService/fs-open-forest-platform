...
describe('noncommercial fields', () => {
  ...
  it('should be valid if paticipants is greater than 0 and spectators is greater than 0 with a sum greater than 75', () => {
  ...
  it('should be valid if paticipants is greater than 75 and spectators is greater than 0', () => {
