...
@NgModule({
  declarations: [ContactInfoComponent, TreeCuttingComponent, TreeCuttingCleanupComponent, TreeGuidelinesComponent, TreeGuidelinesTextComponent, TreeSelectionComponent, TreeSpeciesComponent, StatusPipe, TreeToolsComponent, SidebarViewComponent, WizardViewComponent],
  exports: [ContactInfoComponent, TreeCuttingComponent, TreeCuttingCleanupComponent, TreeGuidelinesComponent, TreeGuidelinesTextComponent, TreeSelectionComponent, TreeSpeciesComponent, StatusPipe, TreeToolsComponent, SidebarViewComponent, WizardViewComponent],
