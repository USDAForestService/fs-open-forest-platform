...
describe('Apply for a temp outfitters permit', () => {
  ...
  it('should submit an application', () => {
    ...
    element(by.id('needGovernmentFacilities')).click();
