...
/**
 * Module for forests public API to create permits and manage transactions
 * @module controllers/forests/permits
 */
 ...
 */
fsForestsPermits.create = async (req, res) => {
  util.logControllerAction(req, 'fsForestsPermits.create', req.body);
 ...
 * @param {Object} res - http response
 */
fsForestsPermits.getOnePermit = async (req, res) => {
  util.logControllerAction(req, 'fsForestsPermits.getOnePermit', { id: req.params.id });
  ...
  try {
    const permit = await forestsDb.fsForestsPermits.findOne(query);
...
fsForestsPermits.printPermit = (req, res) => {
  forestsDb.fsForestsPermits
    ...
    .then((permit) => {
      util.logControllerAction(req, 'fsForestsPermits.printPermit', permit);
 ...
 * @param {Object} res - http response
 */
fsForestsPermits.updatePermitApplication = async (req, res) => {
  util.logControllerAction(req, 'fsForestsPermits.updatePermitApplication', req.body);
...
module.exports = fsForestsPermits;
