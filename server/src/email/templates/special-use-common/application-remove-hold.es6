...
module.exports = (application, defaultApplicationDetails) => {
  return {
    ...
    subject: 'An update on your recent Digital Permitsmitsmits permit application to the Forest Service.',
    body: `
      Digital Permitsmitsmits permit application status update
      *********************************
    ...
    `,
    html: `
    <h2>Digital Permitsmitsmits permit application status update</h2>
