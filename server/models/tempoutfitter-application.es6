...
module.exports = sequelize.define('tempOutfitterApplications', {
  ...
  applicantInfoFaxAreaCode: { type: Sequelize.STRING(3), field: 'applicant_info_fax_areacd' },
  applicantInfoFaxPrefix: { type: Sequelize.STRING(3), field: 'applicant_info_fax_prefix' },
  applicantInfoFaxNumber: { type: Sequelize.STRING(4), field: 'applicant_info_fax_number' },
