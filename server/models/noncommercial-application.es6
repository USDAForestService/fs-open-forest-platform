...
module.exports = sequelize.define(
  'noncommercialApplications',
  {
    ...
    applicantInfoPrimaryMailingAddress: { type: Sequelize.STRING, field: 'appl_info_pri_mailing_address', allowNull: true },
    ...
    applicantInfoPrimaryMailingState: { type: Sequelize.STRING(2), field: 'appl_info_pri_mailing_state', allowNull: true },
    ...
    noncommercialFieldsActivityDescription: { type: Sequelize.STRING(512), field: 'noncomm_fields_activity_descr', allowNull: false },
    noncommercialFieldsLocationDescription: { type: Sequelize.STRING, field: 'noncomm_fields_location_descr', allowNull: false },
    noncommercialFieldsStartDateTime: { type: Sequelize.STRING, field: 'noncomm_fields_start_date_time', allowNull: false },
    noncommercialFieldsEndDateTime: { type: Sequelize.STRING, field: 'noncomm_fields_end_date_time', allowNull: false },
    noncommercialFieldsNumberParticipants: { type: Sequelize.INTEGER, field: 'noncomm_fields_num_participants', allowNull: false },
    ...
    noncommercialFieldsSpectatorCount: { type: Sequelize.INTEGER, field: 'noncomm_fields_spectator_count', allowNull: false }
  },
  {
    timestamps: true
  }
