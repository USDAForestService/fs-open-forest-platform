...
describe('validation tests', () => {
  ...
  describe('validate noncommercial apps', () => {
    ...
    it('should call validate with an evening phone but missing area code and return an error', () => {
      let errors = validation.validateNoncommercial(noncommercialTestData.singlePermitHolderEveningPhoneMissingAreaCode.create());
    ...
    it('should call validate with orgType of Person and a missing primary address and return an error', () => {
      let errors = validation.validateNoncommercial(noncommercialTestData.singlePermitHolderMissingPrimaryAddress.create());
    ...
    it('should call validate with orgType of Person and a primary address with missing state and return an error', () => {
      let errors = validation.validateNoncommercial(noncommercialTestData.singlePermitHolderMissingPrimaryAddressState.create());
    ...
    it('should call validate with orgType of Corporation and a missing org address and return an error', () => {
      let errors = validation.validateNoncommercial(noncommercialTestData.singlePermitHolderOrganizationMissingOrgAddress.create());
    ...
    it('should call validate with orgType of Corporation and an org address with missing state and return an error', () => {
      let errors = validation.validateNoncommercial(noncommercialTestData.singlePermitHolderOrganizationMissingOrgAddressState.create());
    ...
    it('should call validate with orgType of Corporation and a primary address with missing state and return an error', () => {
      let errors = validation.validateNoncommercial(noncommercialTestData.singlePermitHolderOrganizationWithPrimaryAddressMissingState.create());
    ...
    it('should call validate with a secondary address and missing state and return an error', () => {
      let errors = validation.validateNoncommercial(noncommercialTestData.singlePermitHolderWithSecondaryAddressMissingState.create());
