...
module.exports = {
  up: function(queryInterface, Sequelize) {
    return queryInterface.createTable('firewoodPermits', {
      permitId: {
        type: Sequelize.UUID,
      ...
      // minCords: { type: Sequelize.STRING, field: 'min_cords' },
      // maxCords: { type: Sequelize.STRING, field: 'max_cords' },
  ...
  down: function(queryInterface, Sequelize) {
    return queryInterface.dropTable('firewoodPermits');
  }
};
