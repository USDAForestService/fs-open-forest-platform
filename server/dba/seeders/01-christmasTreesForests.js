const forests = [
  {
    ...
    cutting_areas:
          '{ "ELKCREEK": {"startDate": "2019-12-01 12:00:00Z", "endDate": "2019-12-08 19:00:00Z", "name": "Elk Creek"},'
  ...
  },
  {
    ...
    stump_height: 6,
    stump_diameter: 6,
    start_date: '2019-11-14T08:00:00Z',
    end_date: '2019-12-24T08:59:59Z',
    created: 'now()',
    updated: 'now()',
  ...
  },
  {
    ...
    stump_height: 12,
    stump_diameter: 0,
    start_date: '2019-11-08T08:00:00Z',
    end_date: '2019-12-25T08:59:59Z',
    created: 'now()',
    updated: 'now()',
