    ...
    let speciesNotes = [
      {
        ...
        species_id: 1,
        display_order: 1,
        note: 'Admired for the evergreen, symmetrical narrow-conic growth habit'
      },
      {
        id: 2,
        species_id: 1,
        display_order: 2,
        note: 'Likeness is often used in artificial Christmas Trees'
      },
      {
        id: 3,
        species_id: 2,
      ...
      },
      {
        ...
        display_order: 4,
        note:
          'Needles surround the twig and are generally soft to the touch. The shape and positioning of needles on the twig make it resemble a pipe cleaner or bottle brush'
      },
      {
        id: 8,
        species_id: 3,
        display_order: 1,
        note: 'Has shiny, dark green needles'
      },
      {
        id: 9,
        species_id: 3,
        display_order: 2,
        note: 'When needles are crushed, they give off a citrusy smell'
      },
      {
        id: 10,
        species_id: 3,
        display_order: 3,
        note:
          'Distinguished by its sprays of lustrous shiny, dark green needles in two distinct rows which are usually horizontally spread so that both the upper and lower sides of the branches are clearly visible'
      },
      {
        id: 11,
        species_id: 4,
        display_order: 1,
        note: 'Soft, blue green needles that are 2-5” long in bundles of five'
      },
      {
        id: 12,
        species_id: 4,
        display_order: 2,
        note: 'Very full appearance and retains needles through the holiday season'
      },
      {
        id: 13,
        species_id: 4,
        display_order: 3,
        note: 'Little or no fragrance with less allergic reactions as compared to more fragrant trees'
      },
      {
        id: 14,
        species_id: 6,
      ...
      },
      {
        ...
        display_order: 3,
        note:
          'Turns brown and looses needles faster than other tree even if put immediately into water after harvesting'
      },
      {
        id: 32,
        species_id: 13,
      ...
      },
      {
        ...
        species_id: 5,
        display_order: 1,
        note: 'Has needles from 5” to 10” in length.'
      },
      {
        id: 39,
        species_id: 5,
        display_order: 2,
        note: 'Needles are clustered in groups of three on the twig, are flat and two-sided.'
      },
      {
        id: 40,
        species_id: 10,
