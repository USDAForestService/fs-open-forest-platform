...
| Start the server as an admin | `yarn dev` | Server is accessible at http://localhost:8080 |
| Start the server as an authenicated user | `yarn dev:use` | Server is accessible at http://localhost:8080 |
